...
// Replaced with actual Unsplash images as requested
const IMG = {
  plane: "https://images.unsplash.com/photo-1473862215365-97d85b1d4dc5?w=800&q=80",
  painting: "https://images.unsplash.com/photo-1579546929518-9e396f3cc809?w=800&q=80",
  breaker: "https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=800&q=80",
  dog: "https://images.unsplash.com/photo-1517849845537-4d257902454a?w=800&q=80",
  footballer: "https://images.unsplash.com/photo-1518605368461-1e129223706c?w=800&q=80",
  jacket: "https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800&q=80",
  meadow: "https://images.unsplash.com/photo-1490682143684-14369e18dce8?w=800&q=80",
  stripes: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=800&q=80",
} as const;

// per-image rest scale, keyed by img index (1-8). default 1, drop below to shrink.
const SCALE: Partial<Record<number, number>> = {
  1: 0.9, 2: 0.8, 3: 0.9, 4: 0.8, 5: 0.8, 6: 0.9, 7: 0.9, 8: 0.7,
};
